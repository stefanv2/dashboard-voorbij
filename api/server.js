...
const NAVIDROME_PUBLIC_URL = (process.env.NAVIDROME_PUBLIC_URL || "https://muziek.voorbij.duckdns.org/app").replace(/\/$/, "");
...
function albumLink(albumId) {
  if (!albumId) {
    return NAVIDROME_PUBLIC_URL;
  }

  return `${NAVIDROME_PUBLIC_URL}/#/album/${encodeURIComponent(albumId)}/show`;
}
